...
PLR1_mousekbd_control:
                
                          include    "Plr1WasdControl.s"
...
PLR1_follow_path:
                          ...
                          move.w     4(a0),d0
                          add.w      d0,d0
                          and.w      #%0001111111111110,d0               ; 8190
...
notgotweap:
                          ...
                          tst.b      $43(a5)                             ; Enter (Big/small screen)
                          beq.s      .notswapscr
                          tst.b      lastscr
                          bne.s      .notswapscr2
                          st         lastscr
...
PLR1_JoyStick_control:
                          ...
                          tst.b      $61(a5)                             ; Shift (right of space bar)
                          beq.s      .nofaster
                          move.w     #120,d1
                          move.w     #10,d2
...
.nohalve:
                    ...
                    ; bne.s slidelr
                          ...
                          tst.b      $4f(a5)                             ; Backward arrow
                          beq.s      .noleftturn
                          sub.w      d1,d0

.noleftturn:
                          move.l     #KeyMap,a5
                          tst.b      $4e(a5)                             ; Forward arrow
                          beq.s      .norightturn
                          add.w      d1,d0
