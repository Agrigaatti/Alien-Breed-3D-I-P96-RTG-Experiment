...
RTGScrWidth           EQU scrWidth*RTGMult
RTGScrHeight          EQU scrHeight*RTGMult

RTGScrWidthByteOffset EQU (RTGScrWidth*2)
RTGScrMidByteOffset   EQU RTGScrWidthByteOffset*(RTGScrHeight/2)

*********************************************************************************************

scrCopWidth           EQU scrWidth+8                          ; 104

fromPtOffset          EQU 10                                  ; bplcon4+value+bplcon3+value+color0
widthOffset           EQU scrCopWidth*4                       ; 416                                                                   
midOffset             EQU scrCopWidth*4*(scrHeight/2)
...
LevelClipsSize        EQU 50000                               ; 40000

*********************************************************************************************

TitleScrAddrSize      EQU 10240*7                             ; 320*256*7 bitplanes
OptSprAddrSize        EQU 258*16*5                            ; 258*16*5 sprites
PanelSize             EQU 30720                               ; 320*96*8 bitplanse
