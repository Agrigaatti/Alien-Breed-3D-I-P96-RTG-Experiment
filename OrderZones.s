...
OrderZones:
                          ...
                          move.l     ListOfGraphRooms,a0    ; a0=list of rooms to draw.
...
; If this connected zone is supposed to be closer, then ignore it

mustdo:

; The connected zone is supposed to be further away, so if it is closer
; then we need to move to other side of it.
...
; The zone which is further away is for some reason in the closer part
; of the list. We therefore want to move in front of it. a3,d0.w*8 points
